...
// ------------------------------------------------------------
// https://github.com/Azure/service-fabric-services-and-actors-dotnet/blob/develop/src/Microsoft.ServiceFabric.Services/Common/CRC64.cs
...
namespace Microsoft.ServiceFabric.Services
{
    ...
    /// </summary>
    /// <remarks>Slightly modified to return long instead of ulong.</remarks>
    internal static class CRC64
    {
        ...
        public static long ToCRC64(byte[] value)
        {
            ...
            return unchecked((long)(crc ^ 0xffffffffffffffff) + long.MinValue);
        }
    }
}